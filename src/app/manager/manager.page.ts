...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, IonSplitPane, IonMenu, IonRouterOutlet, IonHeader, IonToolbar, IonContent, IonText, IonLabel, IonCard, IonFooter, IonButtons, IonIcon, IonNote, MenuListComponent,],
})
